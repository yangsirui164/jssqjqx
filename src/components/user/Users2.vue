...
<script>
  ...
  export default {
    ...
    methods:{
      saveuserpower(){
        this.$http.post(`${this.base}/api/User/updateUserRole/${this.shouquanid}`,this.value4).then(res=>{
          console.log('更新授权返回')
      ...
      getUserlist(){
        this.$http.post(`${this.base}/api/User/getUserByPage`,this.queryInfo).then(res=>{
      ...
      addUser(){
        ...
        this.$refs.addFormRef.validate(async valid=>{
          ...
          this.$http.post(`${this.base}/api/user/adduser`,this.addform).then(res=>{
            console.log(res)
      ...
      showepowerdialog(id){
        ...
        this.value4=[]
        //  显示授权页面
        this.$http.get(`${this.base}/api/Role/getAllRoleByUser/${id}`).then(res=>{
          console.log('授权返回')
          console.log(res.data)
          ...
          res.data.forEach((item)=>{
            ...
            if(item.rolePower){
              //右面放已经有的权限
              this.value4.push(item.id.toString())
            }
      ...
      hanChtransfer(nextTargetKeys) {
        console.log(nextTargetKeys)
        this.value4 = nextTargetKeys;
      },
      getRowSelection({selectedKeys, itemSelectAll, itemSelect }) {
        return {
      ...
      showeditdialog(id){
        ...
        this.$http.get(`${this.base}/api/user/getuser/${id}`).then(res=>{
          console.log(res.data)
      ...
      removeUserbyid(id){
        ...
        this.$confirm('此操作将永久删除用户, 是否继续?', '提示', {
          ...
          this.$http.get(`${this.base}/api/user/deluser/${id}`).then(
            res=>{
              if(res.data=="Ok"){
      ...
      saveroleinfo(){
        ...
        this.$http.post(`${this.base}/users/${this.userinfo.id}/role`,{
